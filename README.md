...
This is the the code and scripts relevant to the basic setup of the invoicer application and
infrastructure.
...
For example:
```yaml
    working_directory: /go/src/github.com/adavarski/invoicer-go
```
would become:
```yaml
    working_directory: /go/src/github.com/YOUR_ACCOUNT/invoicer-go
```
